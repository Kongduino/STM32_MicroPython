...
#define MICROPY_HW_FLASH_FS_LABEL "WEACT_H743"
...
#define MICROPY_BOARD_EARLY_INIT    WEACT_H743_board_early_init
void WEACT_H743_board_early_init(void);
...
// I2C buses
// NOTE: You can enable more I2C buses here.
...
// SPI buses
// NOTE: You can enable more SPI buses here.
// NOTE: I left SPI3 alone, it's the QSPI bus.
...
// CAN buses
// NOTE: You can enable more CAN buses here.
...
// LEDs
#define MICROPY_HW_LED1 (pin_E3) // the only controlable LED on the board.
